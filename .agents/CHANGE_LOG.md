...
| 2026-06-17 19:06 | 补充阶段学习文档图解要求：按需使用 Mermaid 绘制概念关系图、流程图、依赖图或生命周期图。 | 执行说明、学习记录规范 |
| 2026-06-17 19:15 | 扩展阶段图解要求：实践任务较复杂时可补充代码结构图，说明 schema、工具函数、agent 构造和 demo 入口等代码单元协作关系。 | 执行说明 |
| 2026-06-17 19:22 | 细化代码结构图放置位置：优先跟随“手写实践任务”小节，作为补全 TODO 前的代码地图。 | 执行说明 |
